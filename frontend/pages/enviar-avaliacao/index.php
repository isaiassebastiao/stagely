...
if ($_SESSION["role"] !== "Empresa")
  ...
  <head>
    ...
    <link rel="stylesheet" href="../../assets/css/pages/enviar-avaliacao/index.css" />
    <title>Enviar Avaliação | Stagely</title>
  </head>
  ...
  <?php include "../../components/pages/enviar-avaliacao/sectionUpload.php"; ?>
</body>
...
<script src="../../assets/js/pages/enviar-avaliacao/uploadEvaluations.js"></script>
